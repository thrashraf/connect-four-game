const GameColumn = ({ columnIndex, col, onColumnHover, onColumnClick, hoveredColumn, currentPlayer, playerTurn }: GameColumnProps) => {
  return (
    <div
      key={columnIndex}
...
const GameCell = ({ row, columnIndex, rowIndex, onColumnClick }: GameCellProps) => {
  return (
    <div
